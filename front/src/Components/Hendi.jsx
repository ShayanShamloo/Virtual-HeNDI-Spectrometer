...
function Hendi(props) {
    ...
    test = test.bind();
    getMapBorders = getMapBorders.bind();
    _isMounted = false;
    ...
    const componentDidMount = () => {
        _isMounted=true;
        getMapBorders(0,0,100,100, 'ch_area');
    }
    ...
    const getMapBorders = (x1, y1, x2, y2, state) => {
        if(_isMounted){
            const h = document.getElementById(props.id).clientHeight;
            const w = document.getElementById(props.id).clientWidth;
            console.log(w, h)
            const getX = x =>{
            ...
            setTimeout(getMapBorders,100,[x1,y1,x2,y2])
        }
    ...
    return (
        <div className='hendi-box' id={props.id}>
            <img alt="background" className={`hendi-component ${state.bg?'':'transparent'}`} id='hendi-bg' src='/virtual-hendi/images/hendi-background.png'/>
            <img alt="foreground" className={`hendi-component ${state.fg?'':'transparent'}`} id='hendi-fg' src='/virtual-hendi/images/hendi-foreground.png'/>
            <img alt="coldhead" className={`hendi-component ${state.ch?'':'transparent'}`} id='hendi-ch' src='/virtual-hendi/images/hendi-coldhead.png'/>
            <img alt="stark cell" className={`hendi-component ${state.stark?'':'transparent'}`} id='hendi-stark' src='/virtual-hendi/images/hendi-stark.png'/>
            <img alt="quadrupole" className={`hendi-component ${state.quad?'':'transparent'}`} id='hendi-quad' src='/virtual-hendi/images/hendi-quad.png'/>
            <img alt="laserbeam" className={`hendi-component ${state.laserbeam?'':'transparent'}`} id='hendi-laserbeam' src='/virtual-hendi/images/hendi-laserbeam.png'/>
            <img alt="OCS canister" className={`hendi-component ${state.canister?'':'transparent'}`} id='hendi-ocs-canister' src='/virtual-hendi/images/hendi-ocs-canister.png' useMap='hendi-map'/>
            <Tooltip header={state.activeToolTipHeader} text={state.activeToolTipText} visible={state.toolTipActive}></Tooltip>
            {getToolTipAreas()}
        </div>
    )
}
...
//                 <img alt="background" className={`hendi-component ${this.state.bg?'':'transparent'}`} id='hendi-bg' src='/virtual-hendi/images/hendi-background.png'/>
//                 <img alt="foreground" className={`hendi-component ${this.state.fg?'':'transparent'}`} id='hendi-fg' src='/virtual-hendi/images/hendi-foreground.png'/>
//                 <img alt="coldhead" className={`hendi-component ${this.state.ch?'':'transparent'}`} id='hendi-ch' src='/virtual-hendi/images/hendi-coldhead.png'/>
//                 <img alt="stark cell" className={`hendi-component ${this.state.stark?'':'transparent'}`} id='hendi-stark' src='/virtual-hendi/images/hendi-stark.png'/>
//                 <img alt="quadrupole" className={`hendi-component ${this.state.quad?'':'transparent'}`} id='hendi-quad' src='/virtual-hendi/images/hendi-quad.png'/>
//                 <img alt="laserbeam" className={`hendi-component ${this.state.laserbeam?'':'transparent'}`} id='hendi-laserbeam' src='/virtual-hendi/images/hendi-laserbeam.png'/>
//                 <img alt="OCS canister" className={`hendi-component ${this.state.canister?'':'transparent'}`} id='hendi-ocs-canister' src='/virtual-hendi/images/hendi-ocs-canister.png' useMap='hendi-map'/>
