...
//     render() {
//        return (
//             <TurboSVG className={this.props.className} stroke={this.state.color} strokeWidth={this.state.width} onClick={this.handleClick} />
//             );
//     }
...
//     render() {
//        return (
//             <RotarySVG className={this.props.className} stroke={this.state.color} strokeWidth={this.state.width} onClick={this.handleClick} />
//             );
//     }
// }
